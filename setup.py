...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'misc_images'), glob('misc_images/*')),
        ...
        (os.path.join('share', package_name, 'protos', 'UR3e', 'meshes'), glob('protos/UR3e/meshes/*')),
        (os.path.join('share', package_name, 'protos', 'UR3e', 'textures'), glob('protos/UR3e/textures/*')),
