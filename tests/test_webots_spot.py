...
def generate_test_description():
    ...
    nav2 = IncludeLaunchDescription(
        ...
        launch_arguments={"set_initial_pose": "true"}.items(),
    )
...
class TestSpot(TestWebots):
    ...
    def testNav2Goal(self):
        ...
        goal_message.pose.pose.position.x = 1.0
    ...
    def testMoveitGoal(self):
        ...
        def on_moveit_goal_executing(message):
        ...
        self.wait_for_messages(
            ...
            timeout=60 * 5,
            condition=on_moveit_goal_executing,
        )
