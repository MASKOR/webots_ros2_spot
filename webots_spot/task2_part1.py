...
class MoveGroupActionClient(Node):
    ...
    def __init__(self):
        ...
        joints = {}
        joints['shoulder_pan_joint'] = np.deg2rad(28)
        joints['shoulder_lift_joint'] = np.deg2rad(-218)
        joints['elbow_joint'] = np.deg2rad(32)
        joints['wrist_1_joint'] = np.deg2rad(-172)
        joints['wrist_2_joint'] = np.deg2rad(31)
        joints['wrist_3_joint'] = np.deg2rad(-184)
