...
def generate_launch_description():
    ...
    grid_map_demos_dir = get_package_share_directory('webots_spot')
    ...
    declare_param_file_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            grid_map_demos_dir, 'params', 'octomap_to_gridmap.yaml'),
        description='Full path to the config file to use')

    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        'rviz_config',
        default_value=os.path.join(
            grid_map_demos_dir, 'params', 'octomap_to_gridmap.rviz'),
